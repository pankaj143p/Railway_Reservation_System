  ...
  return (
    <StyledWrapper>
      <div className="card">
        <span>Social</span>
        {/* LinkedIn */}
        <a className="social-link" href="https://www.linkedin.com/in/pankaj077/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
          <svg fill="#0077B5" viewBox="0 0 24 24">
            <path d="M19 0h-14c-2.76 0-5 2.24-5 5v14c0 2.76 2.24 5 5 5h14c2.76 0 5-2.24 5-5v-14c0-2.76-2.24-5-5-5zm-11.75 20h-3v-10h3v10zm-1.5-11.25c-.97 0-1.75-.78-1.75-1.75s.78-1.75 1.75-1.75 1.75.78 1.75 1.75-.78 1.75-1.75 1.75zm15.25 11.25h-3v-5.5c0-1.1-.9-2-2-2s-2 .9-2 2v5.5h-3v-10h3v1.25c.41-.59 1.09-1.25 2-1.25 1.66 0 3 1.34 3 3v7z"/>
          </svg>
        </a>
        {/* Instagram */}
        <a className="social-link" href="https://www.instagram.com/pankaj07._/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
        ...
        {/* Email */}
        <a className="social-link" href="mailto:pankaj114477pankaj@gmail.com" aria-label="Email">
          <svg fill="#EA4335" viewBox="0 0 24 24">
        ...
        {/* GitHub */}
        <a className="social-link" href="https://github.com/pankaj143p/" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
          <svg fill="#181717" viewBox="0 0 24 24">
